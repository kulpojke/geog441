...
+ Python tutorials
    ...
    + _Complicated Tasks_:
        ...
        + Learn a little about synthetic aperture radar remote sensing by [working through the first basic example of sarpy](https://sarpy.readthedocs.io/en/latest/) :boom: This will not be easy! :fire: 
