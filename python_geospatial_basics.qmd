---
title: 'Fundamental Python Stuff'
format:
  revealjs:
    incremental: true 
jupyter: python3
...
## Homework
If you are choosing Python as you language in this course, do the following:
+ Create a jupyter notebook.
+ 


# Exploring Geopandas {background-image="images/pandas.png"}
...
Here we will read a geogson using the `read_file` method.
```{python}
