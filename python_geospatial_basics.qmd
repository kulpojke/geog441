...
they ca also modify things in place, but it is generally bad form.
...
+ The headers are a mess!  Change the column names to be reasonable.
  + Remember, if you want to be able to access the data as an attribute, the column names need to not have spaces in them. For example you can get a column like this `df.aarvark_count
