...
Running Jupyter in VScode offers some advantages (in my opinion).  To do  this you need to install the jupyter extension and the Python Extension. 
...
## Homework {.smaller .scrollable}
A big part of coding is knowing how to use google (or some stupid AI thing, try searching first, the answers are there on the internet do not require the construction of a nuclear power plant to answer)

<img src="https://xkcd.com/1838"></img>

If you are choosing Python as you language in this course, create a jupyter notebook and do the following:
...
+ The headers are a mess!  Change the column names to be reasonable.  Remember, if you want to be able to access the data as an attribute, the column names need to not have spaces in them. Hint: _columns_ is a mutable attribute of the dataframe so `df.columns = some_list_of_the_correct_length` will assign new column names.
:::
