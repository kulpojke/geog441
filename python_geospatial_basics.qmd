...
In this tutorial we  will be looking at sea surface temaperatures using Community Earth System Model 2 (CESM2) data.  This tutorial borrows heavily from [this tutorial](https://comptools.climatematch.io/tutorials/W1D1_ClimateSystemOverview/student/W1D1_Tutorial5.html) by Computational Tools in Climate Science.  
...
Open the dataset and inspect.  It is an Xarray Dataset.  It has coordinates lat/lon coordinates, and it has
